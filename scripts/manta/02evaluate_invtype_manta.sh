...
#SBATCH --job-name=evaluate_type_manta
#SBATCH --output=%x.out
#SBATCH --error=%x.err
...
QUERY_VCF_DIR="$HOME/call_sv/manta/exp1/Sim_01_02_d${d}"
OUT_DIR="$HOME/call_sv/manta/exp1/Sim_01_02_d${d}/evaluate"
...
for sample in Sim_01 Sim_02; do
    ...
    SAMPLE_FIXED_QUERY="$QUERY_VCF_DIR/${sample}_d${d}/results/variants/diploidSV.vcf.gz"
