...
QUERY_VCF_DIR="$HOME/gt/graphaligner/exp1/Sim_01_02_vg_graphaligner_d${d}/vg_call"
OUT_DIR="$HOME/gt/graphaligner/exp1/Sim_01_02_vg_graphaligner_d${d}/evaluate"
...
for sample in Sim_01 Sim_02; do
    ...
    SAMPLE_FIXED_QUERY="$QUERY_VCF_DIR/${sample}_50bp.vcf.gz"
