...
QUERY_VCF="$HOME/graph/vg/exp1/Sim_01_02/deconstruct/Sim_01_02_deconstruct.vcf.gz"
OUT_DIR="$HOME/graph/vg/exp1/Sim_01_02/deconstruct/evaluate_type_sv"
...
FIXED_FULL_QUERY="$OUT_DIR/vg_query_full_fixed.vcf.gz"
fix_vg_vcf "$QUERY_VCF" "$FIXED_FULL_QUERY"
